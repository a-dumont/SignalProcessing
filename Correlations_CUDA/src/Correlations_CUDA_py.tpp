				...
				py::array_t<DataType,py::array::c_style> py_in2, long long int size)
{
	...
	out = (std::complex<DataType>*) malloc(howmany*(size/2+1)*sizeof(std::complex<DataType>));
				...
				py::array_t<DataType,py::array::c_style> py_in2, long long int size)
{
	...
	DataType* out1;
	out1 = (DataType*) malloc(howmany*(size/2+1)*sizeof(DataType));

	DataType* out2;
	out2 = (DataType*) malloc(howmany*(size/2+1)*sizeof(DataType));

	std::complex<DataType>* out3;
	out3 = (std::complex<DataType>*) malloc(howmany*(size/2+1)*sizeof(std::complex<DataType>));
