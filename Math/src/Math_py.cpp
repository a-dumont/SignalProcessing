...
void init_module(py::module &m)
{
	...
	m.def("gradient", &gradient_py<double,int64_t>, "x"_a, "t"_a.noconvert());
	m.def("gradient", &gradient_py<double,uint64_t>, "x"_a, "t"_a.noconvert());
	m.def("gradient", &gradient_py<float,double>, "x"_a, "t"_a.noconvert());
	m.def("gradient", &gradient_py<float,float>, "x"_a, "t"_a.noconvert());
	m.def("gradient", &gradient_py<float,int64_t>, "x"_a, "t"_a.noconvert());
	m.def("gradient", &gradient_py<float,uint64_t>, "x"_a, "t"_a.noconvert());
	
	//Gradient with constant step
	m.def("gradient", &gradient2_py<double,double>, "x"_a, "dt"_a.noconvert());
	m.def("gradient", &gradient2_py<double,float>, "x"_a, "dt"_a.noconvert());
	m.def("gradient", &gradient2_py<double,int64_t>, "x"_a, "dt"_a.noconvert());
	m.def("gradient", &gradient2_py<double,uint64_t>, "x"_a, "dt"_a.noconvert());
	m.def("gradient", &gradient2_py<float,double>, "x"_a, "dt"_a.noconvert());
	m.def("gradient", &gradient2_py<float,float>, "x"_a, "dt"_a.noconvert());
	m.def("gradient", &gradient2_py<float,int64_t>, "x"_a, "dt"_a.noconvert());
	m.def("gradient", &gradient2_py<float,uint64_t>, "x"_a, "dt"_a.noconvert());
	...
	m.def("nth_order_gradient",&nth_order_gradient_py<double,int64_t>,"x"_a.noconvert(),"dt"_a,"M"_a,"N"_a);
	m.def("nth_order_gradient",&nth_order_gradient_py<double,uint64_t>,"x"_a.noconvert(),"dt"_a,"M"_a,"N"_a);
	...
	m.def("nth_order_gradient",&nth_order_gradient_py<float,int64_t>,"x"_a.noconvert(),"dt"_a,"M"_a,"N"_a);
	m.def("nth_order_gradient",&nth_order_gradient_py<float,uint64_t>,"x"_a.noconvert(),"dt"_a,"M"_a,"N"_a);
	
	//Continuous maximum
	m.def("continuous_max",&continuous_max_py<double>,"in"_a);
	m.def("continuous_max",&continuous_max_py<float>,"in"_a);
	m.def("continuous_max",&continuous_max_py<int64_t>,"in"_a);
	m.def("continuous_max",&continuous_max_py<uint64_t>,"in"_a);
	
	//Continuous minimum
	m.def("continuous_min",&continuous_min_py<double>,"in"_a);
	m.def("continuous_min",&continuous_min_py<float>,"in"_a);
	m.def("continuous_min",&continuous_min_py<int64_t>,"in"_a);
	m.def("continuous_min",&continuous_min_py<uint64_t>,"in"_a);
	
	//Reduction of a vector to a scalar
	m.def("Sum",&sum_py<double>,"in"_a);
	m.def("Sum",&sum_py<float>,"in"_a);
	m.def("Sum",&sum_py<uint64_t>,"in"_a);
	...
	m.def("mean",&mean_py<uint64_t>,"in"_a);
	...
	m.def("product",&product_py<int64_t,int64_t>,"in1"_a,"in2"_a);
	m.def("product",&product_py<uint64_t,uint64_t>,"in1"_a,"in2"_a);
	...
	m.def("Sum",&sum_py<int64_t,int64_t>,"in1"_a,"in2"_a);
	m.def("Sum",&sum_py<uint64_t,uint64_t>,"in1"_a,"in2"_a);
	...
	m.def("difference",&difference_py<int64_t,int64_t>,"in1"_a,"in2"_a);
	m.def("difference",&difference_py<uint64_t,uint64_t>,"in1"_a,"in2"_a);
	...
	m.def("division",&division_py<int64_t,int64_t>,"in1"_a,"in2"_a);
	m.def("division",&division_py<uint64_t,uint64_t>,"in1"_a,"in2"_a);
	...
	m.def("minimum",&min_py<int64_t>,"in"_a);
	m.def("minimum",&min_py<uint64_t>,"in"_a);
	
	//Maximum in a vector
	m.def("maximum",&max_py<double>,"in"_a);
	m.def("maximum",&max_py<float>,"in"_a);
	m.def("maximum",&max_py<int64_t>,"in"_a);
	m.def("maximum",&max_py<uint64_t>,"in"_a);
