...
template<class DataType, class DataType2>
py::array_t<DataType,py::array::c_style> product_single_py(py::array_t<DataType,py::array::c_style> py_in1,DataType2 py_in2)
{
	py::buffer_info buf1 = py_in1.request();
	DataType* out = (DataType*) malloc(sizeof(DataType)*buf1.size);
...
template<class DataType, class DataType2>
py::array_t<DataType,py::array::c_style> sum_single_py(py::array_t<DataType,py::array::c_style> py_in1,DataType2 py_in2)
{
	py::buffer_info buf1 = py_in1.request();
	DataType* out = (DataType*) malloc(sizeof(DataType)*buf1.size);
...
template<class DataType, class DataType2>
py::array_t<DataType,py::array::c_style> difference_single_py(py::array_t<DataType,py::array::c_style> py_in1,DataType2 py_in2)
{
	py::buffer_info buf1 = py_in1.request();
	DataType* out = (DataType*) malloc(sizeof(DataType)*buf1.size);
...
template<class DataType, class DataType2>
py::array_t<DataType,py::array::c_style> division_single_py(py::array_t<DataType,py::array::c_style> py_in1,DataType2 py_in2)
{
	py::buffer_info buf1 = py_in1.request();
	DataType* out = (DataType*) malloc(sizeof(DataType)*buf1.size);
