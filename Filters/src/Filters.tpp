...
void filterEdgeLeftAVX<double,double>(uint64_t N, double* in1, double* in2, double* out)
{
	...
	for(uint64_t j=0;j<N2;j++)
	{
        ...
        ymm10 = _mm256_add_pd(ymm10,_mm256_mul_pd(ymm0,ymm3));
		ymm11 = _mm256_add_pd(ymm11,_mm256_mul_pd(ymm1,ymm3));
        out[k+1] = res[0];
        ymm10 = _mm256_permute4x64_pd(ymm10,0b00111001);
        res[3] = res2[0];
        ymm11 = _mm256_permute4x64_pd(ymm11,0b00111001);
        
        ymm10 = _mm256_add_pd(ymm10,_mm256_mul_pd(ymm0,ymm4));
		ymm11 = _mm256_add_pd(ymm11,_mm256_mul_pd(ymm1,ymm4));
        out[k+2] = res[0];
        ymm10 = _mm256_permute4x64_pd(ymm10,0b00111001);
        res[3] = res2[0];
        ymm11 = _mm256_permute4x64_pd(ymm11,0b00111001);

        ymm10 = _mm256_add_pd(ymm10,_mm256_mul_pd(ymm0,ymm5));
		ymm11 = _mm256_add_pd(ymm11,_mm256_mul_pd(ymm1,ymm5));
        out[k+3] = res[0];
        ymm10 = _mm256_permute4x64_pd(ymm10,0b00111001);
        res[3] = res2[0];
        ymm11 = _mm256_permute4x64_pd(ymm11,0b00111001);

        ymm10 = _mm256_add_pd(ymm10,_mm256_mul_pd(ymm0,ymm6));
        out[k+4] = res[0];
        ymm10 = _mm256_permute4x64_pd(ymm10,0b00111001);

        ymm10 = _mm256_add_pd(ymm10,_mm256_mul_pd(ymm0,ymm7));
        out[k+5] = res[0];
        ymm10 = _mm256_permute4x64_pd(ymm10,0b00111001);

        ymm10 = _mm256_add_pd(ymm10,_mm256_mul_pd(ymm0,ymm8));
        out[k+6] = res[0];
        ymm10 = _mm256_permute4x64_pd(ymm10,0b00111001);

        ymm10 = _mm256_add_pd(ymm10,_mm256_mul_pd(ymm0,ymm9));
        out[k+7] = res[0];
        ymm10 = _mm256_permute4x64_pd(ymm10,0b00111001);
...
void filterEdgeLeftAVX<float,float>(uint64_t N, float* in1, float* in2, float* out)
{
	...
	for(uint64_t j=0;j<N2;j++)
	{
        ...
        ymm10 = _mm256_add_ps(ymm10,_mm256_mul_ps(ymm0,ymm2));
		ymm11 = _mm256_add_ps(ymm11,_mm256_mul_ps(ymm1,ymm2));
        out[k] = res[0];
        ymm10 = _mm256_permutevar8x32_ps(ymm10,ymm14);
        res[07] = res2[0];
        ymm11 = _mm256_permutevar8x32_ps(ymm11,ymm14);

        ymm10 = _mm256_add_ps(ymm10,_mm256_mul_ps(ymm0,ymm3));
		ymm11 = _mm256_add_ps(ymm11,_mm256_mul_ps(ymm1,ymm3));
        out[k+1] = res[0];
        ymm10 = _mm256_permutevar8x32_ps(ymm10,ymm14);
        res[7] = res2[0];
        ymm11 = _mm256_permutevar8x32_ps(ymm11,ymm14);
        
        ymm10 = _mm256_add_ps(ymm10,_mm256_mul_ps(ymm0,ymm4));
		ymm11 = _mm256_add_ps(ymm11,_mm256_mul_ps(ymm1,ymm4));
        out[k+2] = res[0];
        ymm10 = _mm256_permutevar8x32_ps(ymm10,ymm14);
        res[7] = res2[0];
        ymm11 = _mm256_permutevar8x32_ps(ymm11,ymm14);

        ymm10 = _mm256_add_ps(ymm10,_mm256_mul_ps(ymm0,ymm5));
		ymm11 = _mm256_add_ps(ymm11,_mm256_mul_ps(ymm1,ymm5));
        out[k+3] = res[0];
        ymm10 = _mm256_permutevar8x32_ps(ymm10,ymm14);
        res[7] = res2[0];
        ymm11 = _mm256_permutevar8x32_ps(ymm11,ymm14);

        ymm10 = _mm256_add_ps(ymm10,_mm256_mul_ps(ymm0,ymm6));
		ymm11 = _mm256_add_ps(ymm11,_mm256_mul_ps(ymm1,ymm6));
        out[k+4] = res[0];
        ymm10 = _mm256_permutevar8x32_ps(ymm10,ymm14);
        res[7] = res2[0];
        ymm11 = _mm256_permutevar8x32_ps(ymm11,ymm14);

        ymm10 = _mm256_add_ps(ymm10,_mm256_mul_ps(ymm0,ymm7));
		ymm11 = _mm256_add_ps(ymm11,_mm256_mul_ps(ymm1,ymm7));
        out[k+5] = res[0];
        ymm10 = _mm256_permutevar8x32_ps(ymm10,ymm14);
        res[7] = res2[0];
        ymm11 = _mm256_permutevar8x32_ps(ymm11,ymm14);

        ymm10 = _mm256_add_ps(ymm10,_mm256_mul_ps(ymm0,ymm8));
		ymm11 = _mm256_add_ps(ymm11,_mm256_mul_ps(ymm1,ymm8));
        out[k+6] = res[0];
        ymm10 = _mm256_permutevar8x32_ps(ymm10,ymm14);
        res[7] = res2[0];
        ymm11 = _mm256_permutevar8x32_ps(ymm11,ymm14);

        ymm10 = _mm256_add_ps(ymm10,_mm256_mul_ps(ymm0,ymm9));
		ymm11 = _mm256_add_ps(ymm11,_mm256_mul_ps(ymm1,ymm9));
        out[k+7] = res[0];
        ymm10 = _mm256_permutevar8x32_ps(ymm10,ymm14);
        res[7] = res2[0];
        ymm11 = _mm256_permutevar8x32_ps(ymm11,ymm14);
