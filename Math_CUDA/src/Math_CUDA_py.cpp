...
void init_math(py::module &m)
{
	...
	m.def("vAddCUDA",&vector_sum_complex_py<int8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vAddCUDA",&vector_sum_complex_py<int16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vAddCUDA",&vector_sum_complex_py<int32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vAddCUDA",&vector_sum_complex_py<int64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vAddCUDA",&vector_sum_complex_py<uint8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vAddCUDA",&vector_sum_complex_py<uint16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vAddCUDA",&vector_sum_complex_py<uint32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vAddCUDA",&vector_sum_complex_py<uint64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	...
	m.def("vProdCUDA",&vector_product_complex_py<int8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vProdCUDA",&vector_product_complex_py<int16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vProdCUDA",&vector_product_complex_py<int32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vProdCUDA",&vector_product_complex_py<int64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vProdCUDA",&vector_product_complex_py<uint8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vProdCUDA",&vector_product_complex_py<uint16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vProdCUDA",&vector_product_complex_py<uint32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vProdCUDA",&vector_product_complex_py<uint64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	...
	m.def("vDiffCUDA",&vector_diff_complex_py<int8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vDiffCUDA",&vector_diff_complex_py<int16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vDiffCUDA",&vector_diff_complex_py<int32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vDiffCUDA",&vector_diff_complex_py<int64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	//m.def("vDiffCUDA",&vector_diff_complex_py<uint8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	//m.def("vDiffCUDA",&vector_diff_complex_py<uint16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	//m.def("vDiffCUDA",&vector_diff_complex_py<uint32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	//m.def("vDiffCUDA",&vector_diff_complex_py<uint64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	...
	m.def("vDivCUDA",&vector_div_complex_py<int8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vDivCUDA",&vector_div_complex_py<int16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vDivCUDA",&vector_div_complex_py<int32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vDivCUDA",&vector_div_complex_py<int64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vDivCUDA",&vector_div_complex_py<uint8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vDivCUDA",&vector_div_complex_py<uint16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vDivCUDA",&vector_div_complex_py<uint32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("vDivCUDA",&vector_div_complex_py<uint64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	...
	m.def("mAddCUDA",&matrix_sum_complex_py<int8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mAddCUDA",&matrix_sum_complex_py<int16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mAddCUDA",&matrix_sum_complex_py<int32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mAddCUDA",&matrix_sum_complex_py<int64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mAddCUDA",&matrix_sum_complex_py<uint8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mAddCUDA",&matrix_sum_complex_py<uint16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mAddCUDA",&matrix_sum_complex_py<uint32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mAddCUDA",&matrix_sum_complex_py<uint64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	...
	m.def("mProdCUDA",&matrix_prod_complex_py<int8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mProdCUDA",&matrix_prod_complex_py<int16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mProdCUDA",&matrix_prod_complex_py<int32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mProdCUDA",&matrix_prod_complex_py<int64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mProdCUDA",&matrix_prod_complex_py<uint8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mProdCUDA",&matrix_prod_complex_py<uint16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mProdCUDA",&matrix_prod_complex_py<uint32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mProdCUDA",&matrix_prod_complex_py<uint64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	...
	m.def("mDiffCUDA",&matrix_diff_complex_py<int8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mDiffCUDA",&matrix_diff_complex_py<int16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mDiffCUDA",&matrix_diff_complex_py<int32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mDiffCUDA",&matrix_diff_complex_py<int64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	//m.def("mDiffCUDA",&matrix_diff_complex_py<uint8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	//m.def("mDiffCUDA",&matrix_diff_complex_py<uint16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	//m.def("mDiffCUDA",&matrix_diff_complex_py<uint32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	//m.def("mDiffCUDA",&matrix_diff_complex_py<uint64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	...
	m.def("mDivCUDA",&matrix_div_complex_py<int8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mDivCUDA",&matrix_div_complex_py<int16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mDivCUDA",&matrix_div_complex_py<int32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mDivCUDA",&matrix_div_complex_py<int64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mDivCUDA",&matrix_div_complex_py<uint8_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mDivCUDA",&matrix_div_complex_py<uint16_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mDivCUDA",&matrix_div_complex_py<uint32_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
	m.def("mDivCUDA",&matrix_div_complex_py<uint64_t>, "In1"_a.noconvert(),"In2"_a.noconvert());
}
